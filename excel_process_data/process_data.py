...
class ExcelManager:
    ...
    def _create_headers_numerate(
        ...
        а значениями — их порядковые номера (начиная с 1_Шампуни, как в openpyxl).
        ...
        :return: Словарь { "Название столбца": индекс_столбца }, где индекс начинается с 1_Шампуни.
        """
    ...
    def load_info_about_user(
        ...
        'Возраст': 30,
        'Тип волос': '2_Масла, 4',
        'Тип кожи головы': 1_Шампуни,
        'Проблемы': 2_Масла,
        'Потребности': 1_Шампуни,
        }
    ...
    def forming_dict_from_collection(
        ...
        """
        В этой функции осуществляется формирование словаря со средствами из листа 'Подборки'
