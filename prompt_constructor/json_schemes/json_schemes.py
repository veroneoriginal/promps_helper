...
def determine_scheme_by_number_of_products(
    ...
    schemes = {
        4: JSON_SCHEME_FOUR_PRODUCTS,
        6: JSON_SCHEME_SIX_PRODUCTS,
    }

    try:
        return schemes[product_count]
    except KeyError as exc:
        raise ValueError(f"Неподдерживаемое количество продуктов: {product_count}") from exc
