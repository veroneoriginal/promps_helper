class PromptConstructor:
    ...
    def __init__(self):
        self.prompts = {
            'Подробный анализ состава': self.products_for_detailed_analysis_composition,
...
Ответ ты должен дать в следующем виде: {data_decrypted['Задача']}"""
    ...
    def products_for_detailed_analysis_composition(
        ...
        для кода "Подробный анализ состава".

        :param data_decrypted: словарь с расшифрованными данными по текущей подборке
       :return: строка с описанием средств
        """

        return f"""Информация о средстве и его составе: {data_decrypted["Средства"]}.
...
Сохраняй нумерацию элементов."""
    ...
    def products_for_code_analogue_product(
       ...
       :return: строка с описанием средств
        ...
        return f"""Информация о средствах, их типе и составах: {data_decrypted["Средства"]}.
...
Учти всю вышепредставленную информацию и проведи анализ составов."""
    ...
    def products_for_code_best_product_carcinogen_free(
        ...
        return f"""Информация о средствах, их типе и составах: {data_decrypted["Средства"]}.
Учти всю вышепредставленную информацию и проведи анализ составов.
Если в составе есть канцерогены, то укажи их названия. Максимально внимательно проверь 
составы на наличие канцерогенов, это очень важно."""
...
"""
    ...
    def products_for_code_best_couple(
        ...
        return f"""Информация о наборах средств:{data_decrypted["Средства"]}.
...
"""
    ...
    def products_for_code_best_combination(
        ...
        return f"""Информация об исходном средстве, к которому подбираем дополнение, и его состав,
