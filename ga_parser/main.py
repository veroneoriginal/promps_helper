...
def start_parser(
    ...
    1_Шампуни. Создаём папку для изображений средств (если её нет)
    1_Шампуни. Получаем список с строками средств, которые надо спарсить
    2_Масла. Запускаем парсинг
    3. сохраняем книгу
