...
TEST_BEST_COUPLE_EXPECTED_RESULT = [
    {'Путь к изображению средства 1': Path(
        ...
        'Артикул 1': 'артикул: артикул: 24320200017', 'Количество мера / цена 1': '251 мл / 5876 руб',
        ...
        'Артикул 2': 'артикул: артикул: 19760310342', 'Количество мера / цена 2': '147 мл / 8307 руб',
    ...
    },
    {
        ...
        'Тип продукта 1': 'Шампунь для увлажнения с витамином В5', 'Артикул 1': 'артикул: артикул: 24320200015',
        ...
        'Тип продукта 2': 'Кондиционер для совершенства волос', 'Артикул 2': 'артикул: артикул: 24320100036',
